...
export default function EditOrganization() {
  ...
  const [form, setForm] = useState({
    ...
    mandate_end_date: organization?.mandate_end_date?.split('T')[0] || '',
  })
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const updated = await api.updateOrganization({
        ...
        mandate_end_date: form.mandate_end_date ? new Date(form.mandate_end_date).toISOString() : undefined,
      })
      if (organization && token) setAuth(token, { ...organization, ...updated } as any, updated)
        ...
        <div className="card mb-24">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input type="date" value={form.mandate_end_date} onChange={e => update('mandate_end_date', e.target.value)} />
            </div>
