    ...
    <div className="container">
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group"><label>{t('join.password')}</label><input type="password" value={form.password} onChange={e => update('password', e.target.value)} required minLength={8} /></div>
